...
import { LayoutDashboard, MonitorSmartphone, ScrollText, DollarSign, ShieldCheck, Settings, Briefcase, Plug, MessageSquare, Sparkles, BarChart3, Target, Zap, Activity } from "lucide-react";
import {
  Sidebar,
  SidebarContent,
  SidebarGroup,
